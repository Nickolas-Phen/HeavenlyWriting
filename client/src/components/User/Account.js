//page where users can update their username, password, date of birth, time of birth, place of birth, email, etc.
...
export default function SignUp(props) {
    ...
    const submitUserInfo = async (e) => {
        ...
        if (userInfo.birthTime)//only append to birthTime if a user has chosen to update it
        {
            if (AM_PM === "AM")
            {
